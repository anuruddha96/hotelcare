...
const Index = () => {
  ...
  // otherwise the pure top-management role would be bounced back to Revenue
  // a tick later after explicitly opening an operations tab.
  ...
  // Keep the pure top_management role revenue-first. top_management_manager
  // must behave like a normal manager so the Housekeeping workspace is visible
  // immediately at the organization landing page.
