...
const hu: Bundle = {
  ...
  back: "Vissza",
  change: "Módosítás",
  staffSignIn: "Dolgozói belépés",
  staffSignOut: "Kijelentkezés",
  signingOut: "Kijelentkezés…",
  signOutFailed: "A kijelentkezés nem sikerült. Próbálja újra.",
...
const es: Bundle = {
  ...
  staffSignOut: "Cerrar sesión",
  signingOut: "Cerrando sesión…",
  signOutFailed: "No se pudo cerrar la sesión. Inténtelo de nuevo.",
...
const mn: Bundle = {
  ...
  back: "Буцах",
  change: "Өөрчлөх",
  staffSignIn: "Ажилтан нэвтрэх",
  staffSignOut: "Гарах",
  signingOut: "Гарч байна…",
  signOutFailed: "Гарч чадсангүй. Дахин оролдоно уу.",
...
const tl: Bundle = {
  ...
  change: "Palitan",
  staffSignIn: "Staff sign-in",
  staffSignOut: "Mag-sign out",
  signingOut: "Nagsa-sign out…",
  signOutFailed: "Hindi makapag-sign out. Pakisubukan muli.",
