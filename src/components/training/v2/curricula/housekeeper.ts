...
export const housekeeperCurriculum: TrainingCurriculum = {
  ...
  steps: [
...

    {
      key: 'my_tasks',
      title: {
        en: 'Your rooms — start cleaning',
        hu: 'Mai szobáid — kezdd el a takarítást',
        es: 'Tus habitaciones de hoy — comienza a limpiar',
        vi: 'Phòng hôm nay — bắt đầu dọn',
        mn: 'Өнөөдрийн өрөөнүүд — цэвэрлэж эхлүүл',
        uk: 'Ваші номери на сьогодні — розпочніть прибирання',
      },
      body: {
        en: 'My Tasks shows the rooms assigned to you. Each card has the room number, type (Daily / Checkout), priority and any guest notes. When you are ready, press and hold Start Cleaning on the card to open the in-room tools. We will continue once you start.',
        hu: 'A Feladataim a rád osztott szobákat mutatja. Minden kártyán szerepel a szobaszám, a típus (Daily / Checkout), a prioritás és a vendég megjegyzései. Ha készen állsz, nyomd meg a Takarítás kezdése gombot a kártyán, hogy megnyisd a szobai eszközöket. Folytatjuk, amint elkezded.',
        es: 'Mis Tareas muestra tus habitaciones asignadas. Cada tarjeta tiene el número de habitación, el tipo (Daily / Checkout), la prioridad y las notas del huésped. Cuando estés listo, pulsa Comenzar Limpieza en la tarjeta para abrir las herramientas dentro de la habitación. Continuaremos una vez que comiences.',
        vi: 'Nhiệm vụ của tôi hiển thị các phòng được giao cho bạn. Mỗi thẻ có số phòng, loại (Daily / Checkout), mức ưu tiên và ghi chú của khách. Khi sẵn sàng, nhấn giữ Bắt đầu Dọn trên thẻ để mở công cụ trong phòng. Chúng tôi sẽ tiếp tục khi bạn bắt đầu.',
        mn: '"Миний даалгавар" танд хуваарилсан өрөөг харуулна. Гарчиг бүрт өрөөний дугаар, төрөл (Daily / Checkout), эрэмбэ, зочны тэмдэглэл байна. Бэлэн бол "Цэвэрлэж эхлэх" товчийг удаан дарж өрөөний багажуудыг нээнэ үү. Эхэлмэгц бид үргэлжлүүлнэ.',
        uk: '«Мої завдання» показує номери, призначені вам. На кожній картці — номер кімнати, тип (щоденне / після виїзду), пріоритет і примітки гостя. Коли будете готові, натисніть і утримуйте «Початок» на картці, щоб відкрити інструменти в номері. Продовжимо, коли ви почнете.',
      },
      route: '/:org',
      tab: 'housekeeping',
