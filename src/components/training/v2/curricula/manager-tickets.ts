...
export const managerTicketsCurriculum: TrainingCurriculum = {
  ...
  description: {
    ...
    uk: 'Черга обслуговування, таймери SLA, фото, призначення й затримка/погодження.',
  },
  ...
  steps: [
    {
      ...
      body: {
        ...
        uk: 'Усі заявки від покоївок, рецепції чи гостей — тут із фото та SLA. Фільтруйте за кімнатою, статусом, відділом чи пріоритетом.',
      },
      route: '/:org',
      tab: 'tickets',
    ...
    },
    {
      ...
      body: {
        ...
        uk: 'Назва · кімната · колір SLA · виконавець · вік. Зелений = у межах, жовтий = на межі, червоний = прострочено.',
      },
      route: '/:org',
      tab: 'tickets',
    ...
    },
    {
      ...
      title: {
        ...
        uk: 'Призначення на обслуговування',
      },
      body: {
        ...
        uk: 'Відкрийте заявку та оберіть виконавця — він одразу отримає push, а SLA почне рахуватись на нього.',
      },
      route: '/:org',
      tab: 'tickets',
    ...
    },
    {
      ...
      title: {
        ...
        uk: 'Утримання й погодження дорогих ремонтів',
      },
      body: {
        ...
        uk: 'Технік може поставити заявку на Утримання з кошторисом. SLA зупиняється до вашого погодження. Погоджуйте чи відхиляйте у деталях.',
      },
      route: '/:org',
      tab: 'tickets',
