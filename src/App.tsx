...
const TenantRouter = () => {
  ...
  return <TenantProvider organizationSlug={organizationSlug}><Suspense fallback={<PageLoader />}><Routes>
    ...
    <Route path="/reception/breakfast-upload" element={<ReceptionHome />} />
    <Route path="/assistant" element={<AssistantPage />} />
    <Route path="/assistant/:threadId" element={<AssistantPage />} />
    <Route path="/assistant-insights" element={<AssistantInsights />} />
    <Route path="/billing" element={<Billing />} />
  </Routes><AssistantLauncher /></Suspense></TenantProvider>;
};

const PublicBreakfastApp = () => <TranslationProvider><TooltipProvider><Toaster /><ServiceOutageBanner /><BrowserRouter><Suspense fallback={<PageLoader />}><Routes><Route path="/bb" element={<Breakfast />} /><Route path="/bb/auth" element={<BreakfastAuth />} /><Route path="/bb/org/:orgSlug" element={<Breakfast />} /><Route path="/bb/org/:orgSlug/:hotelCode" element={<Breakfast />} /><Route path="/bb/:hotelCode" element={<Breakfast />} /></Routes></Suspense></BrowserRouter></TooltipProvider></TranslationProvider>;
...
const MainApp = () => <QueryClientProvider client={queryClient}><TranslationProvider><AuthProvider><TooltipProvider><Toaster /><PointerEventsGuard /><ExecutiveResumeRefresh /><ServiceOutageBanner /><SystemAnnouncementBanner /><BrowserRouter><AuthenticatedShell><Suspense fallback={<PageLoader />}><Routes><Route path="/" element={<RootRedirect />} /><Route path="/auth" element={<Auth />} /><Route path="/oauth/consent" element={<OAuthConsent />} /><Route path="/:organizationSlug/:hotelSlug/minibar/:roomToken" element={<GuestMinibar />} /><Route path="/:organizationSlug/minibar/:roomToken" element={<GuestMinibar />} /><Route path="/:organizationSlug/*" element={<TenantRouter />} /><Route path="*" element={<NotFound />} /></Routes></Suspense></AuthenticatedShell></BrowserRouter></TooltipProvider></AuthProvider></TranslationProvider></QueryClientProvider>;
const App = () => typeof window !== "undefined" && window.location.pathname.startsWith("/bb") ? <PublicBreakfastApp /> : <MainApp />;
export default App;
