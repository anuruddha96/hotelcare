...
-- 4. Drop all existing storage policies and recreate them securely
...
CREATE POLICY "Secure ticket attachment upload" 
ON storage.objects 
FOR INSERT 
WITH CHECK (
  bucket_id = 'ticket-attachments' 
...
CREATE POLICY "Secure ticket attachment update" 
ON storage.objects 
FOR UPDATE 
USING (
  bucket_id = 'ticket-attachments' 
...
CREATE POLICY "Secure ticket attachment delete" 
ON storage.objects 
FOR DELETE 
USING (
  bucket_id = 'ticket-attachments' 
