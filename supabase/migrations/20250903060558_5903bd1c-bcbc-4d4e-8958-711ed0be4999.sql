...
create policy if not exists "Admins manage ticket creation config"
...
drop trigger if exists set_ticket_creation_config_updated_at on public.ticket_creation_config;
